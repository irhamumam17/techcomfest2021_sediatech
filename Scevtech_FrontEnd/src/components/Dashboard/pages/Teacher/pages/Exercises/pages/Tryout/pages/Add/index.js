...
class Add extends Component {
	...
	handleSubmit = async (e) => {
		...
		// sent to tryout context and waiting response from server
		let deadline = this.state.date + ' ' + this.state.time + ':00';
		let status = await this.context.addTryout({
		...
		// redirect
		if(status === 200) {
			this.props.history.push('/teacher/exercises/tryout/list');
		}
	}
		...
		return(
			<React.Fragment>
				<motion.div className="dashboard-title"
					...
					>
					<h2 className="text-xl font-bold">Tambah Latihan Soal</h2>
					<h4 className="text-md italic lowercase text-gray-400">
						...
						<span className="mx-1">/</span>
						<Link to="/teacher/exercises/tryout/add" className="hover:underline hover:text-blue-400">tambah </Link> 
					</h4>
				</motion.div>
				<motion.div
						variants={Variants}
					...
					>
					<Link to="/teacher/exercises/tryout/list" className="button-header">Daftar Latihan Soal</Link>
				</motion.div>
								...
								<div className="flex flex-row gap-4">
									<div className="w-1/2">
										<div className="form-group">
											...
											<div className="flex flex-row gap-2">
												<input type="date" name="date" onChange={this.handleChange} className="form-input"/>
												<input type="time" name="time" onChange={this.handleChange} className="form-input"/>
											</div>
										</div>
									</div>
									<div className="w-1/2 flex flex-row gap-2">
										<div className="form-group">
											...
											<input type="number" name="duration" onChange={this.handleChange} placeholder="dalam menit" className="form-input" />
										</div>
										<div className="form-group">

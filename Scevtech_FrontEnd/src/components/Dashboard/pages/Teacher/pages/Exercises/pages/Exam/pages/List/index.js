				...
				<motion.div className="dashboard-title"
					...
					<div>
						...
						<h4 className="text-md italic lowercase text-gray-400">
							...
							<span className="mx-1">/</span>
							<Link to="/teacher/exercises/exam/list" className="hover:underline hover:text-blue-400">daftar </Link> 
						</h4>
					</div>
				</motion.div>
				<motion.div
					...
					>
					<Link to="/teacher/exercises/exam/add" className="button-header">Buat Ujian</Link>
											...
											<tr key={key}>
												...
												<td className="text-center">
													<Tippy content="hapus" delay={300}>
														<button onClick={() => this.context.removeExam(exam.id)} className="badge-icon bg-red">

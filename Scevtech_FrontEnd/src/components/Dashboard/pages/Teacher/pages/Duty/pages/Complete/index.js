		...
		return(
			<React.Fragment>
				<motion.div className="dashboard-title"
					...
					<div>
						<h2 className="text-xl font-bold">Tugas Selesai</h2>
						<h4 className="text-md italic lowercase text-gray-400">
							...
							<span className="mx-1">/</span>
							<Link to="/teacher/duty/complete" className="hover:underline hover:text-blue-400">selesai </Link> 
						</h4>
					</div>
				</motion.div>
				<motion.div
									...
									<motion.div className="bg-white rounded shadow-md overflow-hidden"
										...
										<div className="px-4 pb-4">
											...
											<div className="flex flex-row justify-between items-center mt-2 pt-2 border-t-2 border-gray-200">
												<a href="/teacher/duty/detail" className="text-white py-1 px-4 bg-blue-400 rounded inline-block mt-2 uppercase font-semibold text-sm transition duration-200 hover:bg-blue-500">Detail</a>
...
Complete.contextType = DutyContext;

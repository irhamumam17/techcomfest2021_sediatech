		...
		return(
			<React.Fragment>
				<motion.div className="dashboard-title"
					...
					<div>
						<h2 className="text-xl font-bold">Draft Tugas</h2>
						<h4 className="text-md italic lowercase text-gray-400">
							...
							<span className="mx-1">/</span>
							<Link to="/teacher/duty/draft" className="hover:underline hover:text-blue-400">draft </Link> 
						</h4>
					</div>
				</motion.div>
				<motion.div

...
class Add extends Component {
	...
	async handleSubmit(e) {
		...
		if(response === 200) {
			this.props.history.push('/teacher/student/list');
		}
	}
				...
				<motion.div className="dashboard-title"
					...
					<div>
						...
						<h4 className="text-md italic lowercase text-gray-400">
							...
							<span className="mx-1">/</span>
							<Link to="/teacher/student/add" className="hover:underline hover:text-blue-400">tambah </Link> 
						</h4>
					</div>
				</motion.div>
				<motion.div
					...
					<Link to="/teacher/student/list" className="button-header">Lihat Daftar Siswa</Link>
				</motion.div>

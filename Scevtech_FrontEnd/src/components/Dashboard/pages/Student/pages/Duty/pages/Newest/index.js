				...
				<motion.div className="dashboard-title"
					...
					<div>
						...
						<h4 className="text-md italic lowercase text-gray-400">
							...
							<span className="mx-1">/</span>
							<Link to="/teacher/duty/new" className="hover:underline hover:text-blue-400">terbaru </Link> 
						</h4>
					</div>
				</motion.div>
				<motion.div
					...
					>
					<Link to="/student/duty/all" className="button-header" >Semua Tugas</Link>
				</motion.div>
...
Newest.contextType = DutyContext;

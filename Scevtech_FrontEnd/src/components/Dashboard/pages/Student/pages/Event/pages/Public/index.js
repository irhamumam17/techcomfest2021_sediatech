		...
		return(
			<React.Fragment>
				...
				>
					...
					<div>
						<h2 className="text-xl font-bold">Event Umum</h2>
						<h4 className="text-md italic lowercase text-gray-400">
							<Link to="/student/dashboard" className="hover:underline hover:text-blue-400">siswa</Link> 
							<span className="mx-1">/</span>
							<Link to="/student/event/school" className="hover:underline hover:text-blue-400">event </Link> 
							<span className="mx-1">/</span>
							<Link to="/student/event/public" className="hover:underline hover:text-blue-400">umum </Link> 
						</h4> 
					</div>
				</motion.div>
				{
					(this.context.loading.publics) ?
						<Loading status={this.context.loading.publics} size="large" />
					:
						<div className="flex flex-row gap-4 my-4">
							{
								this.context.events.publics.map((event , key) => {
									return(
											...
											<div className="bg-white rounded shadow-md overflow-hidden">
												...
												<div className="px-4 pb-4">
													...
													<div className="flex flex-row justify-between items-center mt-2 pt-2 border-t-2 border-gray-200">
														<Link to={"/student/event/detail/" + event.id} className="text-white py-1 px-4 bg-blue-400 rounded inline-block mt-2 uppercase font-semibold text-sm transition duration-200 hover:bg-blue-500">Detail</Link>
...
Public.contextType = EventContext;
